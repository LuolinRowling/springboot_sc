...
<jsp:include page="header.jsp">
    <jsp:param  name="title" value="修改教室" />
</jsp:include>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                修改教室
                <small>修改教室分配设备</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-gears"></i> 设备管理</a></li>
                <li>编辑设备</li><li>分配设备</li><li>修改教室</li>
            </ol>
        </section>
                        ...
                        <form class="form-horizontal">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="editBuilding" class="col-sm-2 control-label">教学楼</label>

                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="editBuilding" placeholder="教学楼" disabled>
                                    </div>
                                    <label for="editClassroom" class="col-sm-1 control-label">教室号</label>

                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="editClassroom" placeholder="教室号" disabled>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" id="editComputerClassroom">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" id="editCameraClassroom">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" id="editProjectorClassroom">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control" id="editRaspberryClassroom">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control" id="editInputRaspberry" placeholder="树莓派序列号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" id="editSinglechipClassroom">
                            ...
                            <div class="box-footer">
                                <p class="label label-danger classroom-wrong-tip" style="display:none;margin-top: 5px;float: left;" >修改失败！</p>
                                <button type="button" class="btn btn-info pull-right" onclick="editClassroomDevice()">修改教室</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
...
<script src="./xset/editClassroom.js"></script>
